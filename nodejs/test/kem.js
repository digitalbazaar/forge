...
function Tests(ASSERT, KEM, MD, MGF, RSA, UTIL, JSBN, RANDOM) {
  ...
  describe('kem', function() {
    it('should escrypt and decrypt', function() {
      for ( var i=0; i<1; i++ ) {
        ...
        var kdf = MGF.mgf1.create(MD.sha256.create());
  ...
  describe('RsaKeyEncapsulationTestVectors', function() {
    ...
    it("Test 1", function() {
      ...
      var kdf = MGF.mgf1.create(MD.sha1.create());
    ...
    it("Test 2", function() {
      ...
      var kdf = MGF.mgf1.create(MD.sha1.create(),null,1);
    ...
    it("Test 3", function() {
      ...
      var kdf = MGF.mgf1.create(MD.sha256.create(), 20);
    ...
    it("Test 4", function() {
      ...
      var kdf = MGF.mgf1.create(MD.sha256.create(), 20, 1);
...
if(typeof define === 'function') {
  define([
    ...
    'forge/jsbn',
    'forge/random'
  ], function(KEM, MD, MGF, RSA, UTIL, JSBN, RANDOM) {
    Tests(
