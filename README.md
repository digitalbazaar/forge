...
//generate a ED25519 certificate
const pki = forge.pki;

// not sure if 64bit keys are valid for openssl, didn't test yet
const edKeyPair = ed25519.generateKeyPair({skBits:32})
