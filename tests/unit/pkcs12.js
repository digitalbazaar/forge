...
(function() {
  ...
  describe('pkcs12', function() {
    ...
    it('Issue #1127 optional macData is okay rfc5280#section-4.1.1.2', function() {
      var b64Pfx = 'MIIKYAIBAzCCChwGCSqGSIb3DQEHAaCCCg0EggoJMIIKBTCCBhYGCS' +
      ...
      var p12Der = forge.util.decode64(b64Pfx);
